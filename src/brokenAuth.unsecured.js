...
// Vulnerable password reset endpoint that doesn't require previous password authentication
...
// This is even more dangerous because it doesn't require JWT verification
app.post('/reset-password-dangerous', (req, res) => {
    const { username, newPassword } = req.body
    const user = users[username]
